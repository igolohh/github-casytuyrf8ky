...
import { ChevronDown, ChevronUp, Clock, Calendar, User, Building2, Briefcase } from 'lucide-react';
          ...
          >
            ...
            {isExpanded && (
              <div className="px-4 pb-4 pt-0 border-t border-gray-100">
                {(entry.satuan || entry.realisasi) && (
                  <div className="mb-3">
                    {entry.satuan && (
                      <div className="mb-1">
                        <span className="text-sm font-medium text-gray-700">Satuan: </span>
                        <span className="text-gray-600">{entry.satuan}</span>
                      </div>
                    )}
                    {entry.realisasi && (
                      <div>
                        <span className="text-sm font-medium text-gray-700">Realisasi: </span>
                        <span className="text-gray-600">{entry.realisasi}</span>
                      </div>
                    )}
                  </div>
                )}
